...
<head>
  ...
  <title>Nimeric / Authatication</title>
  ...
  * App Autor : [
      - Adonaimbula3@gmail.com
      - glodymputu243@gmail.com
    ].
  ======================================================== -->
</head>
...
<body>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Nimeric</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" id="button">Login</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0"><a href="">Nimeric</a></p>
                    </div>
                  </form>
  ...
  <!-- jquery-validation -->
<script src="<?= URL ?>public/assets/vendor/jquery-validation/jquery.validate.min.js"></script>
<script src="<?= URL ?>public/assets/vendor/jquery-validation/additional-methods.min.js"></script>
<script src="<?= URL ?>public/assets/vendor/jquery.form.min.js"></script>
