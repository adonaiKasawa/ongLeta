...
class Database extends PDO
{
  ...
  {
    $pgsql = $DB_TYPE . ':host=' . $DB_HOST . ';port=' . $DB_PORT . ';dbname=' . $DB_NAME . ';user=' . $DB_USER . ';password=' . $DB_PASS;
    $mysql = $DB_TYPE . ':host=' . $DB_HOST . ';dbname=' . $DB_NAME . ';user=' . $DB_USER . ';password=' . $DB_PASS;
    parent::__construct($DB_TYPE == 'pgsql' ? $pgsql : $mysql);
  }
